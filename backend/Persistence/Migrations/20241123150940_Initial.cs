        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeadWeeks = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerNotes = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    StylistNotes = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceStylists", x => new { x.ServicesId, x.StylistsId });
                    table.ForeignKey(
                        name: "FK_ServiceStylists_Services_ServicesId",
                        column: x => x.ServicesId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceStylists_Users_StylistsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceStylists_StylistsId",
